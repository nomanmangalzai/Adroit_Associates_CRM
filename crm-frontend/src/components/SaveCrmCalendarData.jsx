...
const SaveCrmCalendarData = () => {
  ...
  const saveCrmCalendarData = async (data) => {
    try {
      const response = await fetch('http://localhost:5000/crm-calendar/save-crm-calendar-data', {
        method: 'POST',
        headers: {
    ...
    <Container>
      <Row className="justify-content-center">
        <Col md={6}>
          ...
          {responseMessage && (
            <Alert variant={responseMessage.ok ? 'success' : 'danger'} onClose={() => setResponseMessage('')} dismissible>
              {responseMessage}
            </Alert>
          )}
          <Formik
            ...
            {({ isSubmitting }) => (
              <Form>
                ...
                <BootstrapForm.Group controlId="contactTitle">
                  ...
                  <Field type="text" id="contactTitle" name="contactTitle" className="form-control" />
                  <ErrorMessage name="contactTitle" component="div" className="text-danger" />
                </BootstrapForm.Group>
                ...
                <BootstrapForm.Group controlId="meetingSubject">
                  ...
                  <Field type="text" id="meetingSubject" name="meetingSubject" className="form-control" />
                  <ErrorMessage name="meetingSubject" component="div" className="text-danger" />
                </BootstrapForm.Group>

                <BootstrapForm.Group controlId="clientPOC">
                  <BootstrapForm.Label>Client POC</BootstrapForm.Label>
                  <Field type="text" id="clientPOC" name="clientPOC" className="form-control" />
                  <ErrorMessage name="clientPOC" component="div" className="text-danger" />
                </BootstrapForm.Group>
                ...
                <BootstrapForm.Group controlId="additionalNotes">
                  ...
                  <Field as="textarea" id="additionalNotes" name="additionalNotes" className="form-control" rows={3} />
