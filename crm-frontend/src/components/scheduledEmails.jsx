      ...
      <ListGroup>
        {emails.map((email) => (
          ...
          >
            ...
            {email.editable ? (
              <div>
                <input type="text" value={email.recipient} />
                <input type="text" value={email.subject} />
                <input type="text" value={email.message} />
                <button onClick={() => handleSaveChanges(email._id)}>Save Changes</button>
              </div>
            ) : (
              <button onClick={() => handleEditClick(email._id)}>Edit</button>
            )}
          </ListGroup.Item>
        ))}
      </ListGroup>
